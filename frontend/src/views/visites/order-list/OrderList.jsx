...
import ReporVisite from '../ReporVisite'
    ...
    <div className="table-container">
      <div className="table-header">
        ...
        <Link to='/admin/basic/add-order'>
          <button className="new-user-btn">+ New Visite</button>
        </Link>
        <ReporVisite filteredBooking={currentRecords} />
                ...
                <tr key={index}>
                  ...
                  <td>
                    ...
                    <Menu
                      ...
                      onClose={handleClose}>
                      <Link to={`/admin/orders/update-order/${order.OrderID}`}>
